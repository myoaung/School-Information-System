    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {showForm && (
        <form
          ...
          className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6 mb-6"
        >
      ...
      {announcements.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" aria-live="polite">
          {announcements.map((a) => (
            <div
              key={a.id}
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-md shadow-purple-100/50 p-6 hover:shadow-lg transition-shadow relative"
            >
              {isNew(a.created_at) && (
              ...
              {(a.grade_name || a.class_name) && (
                <div className="flex flex-wrap gap-1.5 mb-3">
                  {a.grade_name && (
                    <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 text-xs rounded-full">
                      {a.grade_name}
                    </span>
                  )}
                  {a.class_name && (
                    <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 text-xs rounded-full">
                      {a.class_name}
                    </span>
                  )}
                </div>
              ...
              <p className="text-sm text-purple-600/70 dark:text-purple-300/70 mb-4 line-clamp-3">
                {a.content}
              </p>
              <Link
                to={`/announcements/${a.id}`}
                className="inline-flex items-center gap-1 text-sm font-semibold text-purple-600 dark:text-purple-400 hover:text-purple-800 transition-colors"
              >
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-2xl shadow-md shadow-purple-100/50">
          <svg
            className="w-12 h-12 text-purple-300 dark:text-purple-600 mx-auto mb-3"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
