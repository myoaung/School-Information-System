          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="text-sm text-purple-700 dark:text-purple-300 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-purple-100 file:text-purple-700 dark:file:bg-purple-900/50 dark:file:text-purple-300 hover:file:bg-purple-200 dark:hover:file:bg-purple-800/50 cursor-pointer"
              />
              {form.photo_url && (
                <img
                  src={form.photo_url}
