        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6">
              ...
              <p className="text-3xl font-bold text-purple-900 dark:text-purple-100">
                {overview.quizAttempts?.avg_score || '—'}
              </p>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6">
              ...
              <div className="space-y-3">
                {overview.topStudents.map((s, i) => (
                  <div
                    key={s.id}
                    className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-950/40 rounded-lg"
                  >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-purple-900 dark:text-purple-100">
                  {studentReport.student.studentId}
                </p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                  {studentReport.attendance?.total || 0}
                </p>
                <p className="text-sm text-purple-600 dark:text-purple-400">Total</p>
              </div>
              <div className="text-center">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                {studentReport.attendance?.rate || 0}%
              </p>
            </div>
          </div>
                  ...
                  {studentReport.grades.map((g) => (
                    <tr key={g.id} className="border-t border-purple-100 dark:border-purple-800">
                      <td className="px-4 py-3">
                        <span className="px-2 py-0.5 bg-indigo-100 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-300 rounded-full text-xs font-medium">
                          {g.subject_code}
                        </span>
                      </td>
          ...
          {teacherReport && (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <StatCard
                  label="Subjects"
                  value={[...new Set(teacherReport.courses.map((c) => c.subject_code))].length}
                  color="orange"
                />
              </div>
...
const StatCard = memo(function StatCard({ label, value, color }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-4 text-center">
      <p
        className={`text-3xl font-bold ${textColors[color] || 'text-purple-900 dark:text-purple-100'}`}
      >
        {value}
      </p>
