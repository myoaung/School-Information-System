      ...
      {courses.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((c) => (
            <div
              key={c.id}
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-md shadow-purple-100/50 p-6 hover:shadow-lg transition-shadow relative group"
            >
              <div className="flex items-center gap-2 mb-3">
                <span className="px-2 py-0.5 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 rounded-full text-xs font-medium">
                  {c.subject_code}
                </span>
              ...
              {c.description && (
                <p className="text-sm text-purple-600/60 dark:text-purple-300/60 line-clamp-2">
                  {c.description}
                </p>
              )}
              <div className="mt-4 flex items-center justify-between">
                <Link
                  to={`/courses/${c.id}`}
                  className="text-purple-600 dark:text-purple-400 text-sm font-medium hover:text-purple-800"
                >
