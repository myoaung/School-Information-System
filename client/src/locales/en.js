const en = {
  ...
  register: {
    ...
    email: 'Email address',
    phone: 'Phone Number',
    phonePlaceholder: '09xxxxxxxxx (optional)',
    password: 'Password',
    confirmPassword: 'Confirm Password',
    role: 'Role',
    roleNote: 'Teacher and admin accounts are assigned by administrators.',
    student: 'Student',
    teacher: 'Teacher',
    admin: 'Admin',
    parent: 'Parent',
  ...
  curriculum: {
    ...
    addEntry: 'Add Subject',
    copyFromPreviousYear: 'Copy from Previous Year',
    copyCurriculum: 'Copy Curriculum',
    sourceYear: 'Source Year',
    targetYear: 'Target Year',
    copiedSuccess: 'Curriculum entries copied successfully',
    createSuccess: 'Curriculum entry created',
    updateSuccess: 'Curriculum entry updated',
    deleteSuccess: 'Curriculum entry deleted',
    confirmDelete: 'Are you sure you want to remove this subject from the curriculum?',
    grade: 'Grade',
    subject: 'Subject',
  },
  contact: {
  ...
  common: {
    ...
    delete: 'Delete',
    confirm: 'Confirm',
    role: { student: 'Student', teacher: 'Teacher', admin: 'Admin', parent: 'Parent' },
  ...
  teacherWorkload: {
    ...
    heavyWorkload: 'Heavy',
    normalWorkload: 'Normal',
    lightWorkload: 'Light',
    totalPeriods: 'Total Periods',
    noSchedule: 'No schedule data available.',
    noTeachers: 'No teachers found.',
    loadError: 'Failed to load teacher workload.',
    detailError: 'Failed to load teacher schedule.',
    level: {
      light: 'Light',
      normal: 'Normal',
      heavy: 'Heavy',
