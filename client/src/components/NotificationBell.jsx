        ...
        <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-purple-100 dark:border-gray-700 overflow-hidden z-50">
          <div className="flex items-center justify-between px-4 py-3 border-b border-purple-100 dark:border-gray-700">
            ...
            {unreadCount > 0 && (
              <button
                onClick={markAllRead}
                className="text-xs text-purple-600 dark:text-purple-400 hover:text-purple-800 cursor-pointer"
              >
                Mark all read
              </button>
            )}
          ...
          >
            {notifications.length ? (
              notifications.map((n) => (
                <div
                  key={n.id}
                  className={`px-4 py-3 border-b border-purple-50 dark:border-gray-700/50 last:border-0 ${
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-purple-400 dark:text-purple-500 mt-1">
                    ...
                    {!n.read && (
                      <button
                        ...
                        className="w-2 h-2 bg-purple-500 rounded-full mt-2 shrink-0 cursor-pointer"
                        title="Mark as read"
                      />
                    )}
                  </div>
